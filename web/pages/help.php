...
<div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
	<p>
		<h1 class="text-gray-700 dark:text-gray-400"><i class="fas fa-search-location"></i><a name="players"> How are players tracked? Or, why is my name listed more than once?</a></h1><br>
			<?php
				if ($g_options['Mode'] == 'NameTrack')
				{
			?>
			<span class="text-gray-700 dark:text-gray-400">
				Players are tracked by nickname. All statistics for any player using a particular name will be grouped under
				 that name. It is not possible for a name to be listed more than once for each game.<br><br>
			</span>
			<?php
				}
				else
